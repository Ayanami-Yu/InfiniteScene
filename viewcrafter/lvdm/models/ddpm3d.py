    ...
    def configure_optimizers(self):
        ...
        if self.fix_temporal:
            ...
            def matches_temporal(s):
                ...
                return (
                    bool(re.match(pattern_input_output, s))
                    or bool(re.match(pattern_middle, s))
                    or "temopral_conv" in s
                    or "init_attn" in s
                )
...
class VIPLatentDiffusion(LatentVisualDiffusion):
    ...
    def log_images(
        ...
        **kwargs,
        ...
        z, c, x, xc, fs, cond_x, x_cond = self.get_batch_input(
            batch,
            random_uncond=False,
            return_first_stage_outputs=True,
            return_original_cond=True,
